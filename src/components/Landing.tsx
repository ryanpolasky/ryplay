    ...
    <div className="min-h-screen flex items-center justify-center bg-[#060609] relative overflow-hidden">
      ...
      >
        <h1 className="text-6xl mb-2">
          <Logo className="text-6xl" pastelIndex={paletteIdx} onClick={cyclePalette} />
        </h1>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-3 text-sm text-white/60 leading-relaxed">
                <p>
                  <strong className="text-white/80">Last.fm</strong> is a free service that
                  tracks every song you listen to across all your music apps. It's been
                  around since 2002 and works with Spotify, Apple Music, Tidal, and more.
                </p>

                <div className="rounded-xl bg-white/5 p-4 flex flex-col gap-2">
                  <p className="text-white/70 font-medium text-xs uppercase tracking-wider">Quick setup</p>
                  <ol className="list-decimal list-inside flex flex-col gap-1.5 text-white/50 text-[13px]">
                    <li>Create a free account at <a href="https://www.last.fm/join" target="_blank" rel="noopener noreferrer" style={{ color: palette.from }} className="hover:underline">last.fm/join</a></li>
                    <li>Go to <a href="https://www.last.fm/settings/applications" target="_blank" rel="noopener noreferrer" style={{ color: palette.from }} className="hover:underline">Settings &rarr; Applications</a> and connect your music service (Spotify, Apple Music, etc.)</li>
                ...
                <p className="text-white/40 text-xs">
                  This site only reads your public listening data - no passwords, no login required.
                  Your Last.fm profile is public by default, so all this site needs is your username.
                </p>
              </div>
